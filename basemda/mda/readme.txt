    ...
    The project located in this directory has been generated by Francois Le Fevre
    ...
    that a model called 'basemda' has been created within your Magic Draw model.

    Important: before launching AndroMDA, be sure to have exported your model.

    /basemda J2EE project
         |
    ...
    this might be a directory looking like this:
        ...
        (*nix)
        /home/Francois Le Fevre/.m2/repository/basemda/
